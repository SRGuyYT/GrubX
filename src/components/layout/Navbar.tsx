    ...
    <nav className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-border/40 transition-all duration-300">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-6">
          <Link
            href="/"
            className="flex items-center gap-3 text-primary font-bold text-2xl tracking-tighter hover:opacity-80 transition-opacity"
          >
            <img
              src="/64x64.png"
              alt="Grubed X"
              className="h-10 w-10 rounded-xl border border-white/10 bg-black/50 object-cover shadow-lg shadow-black/30"
            />
